...
export const HeroSec = () => {
    return (
      <div className="flex justify-center items-center gap-12 w-screen bg-gray-300 h-[450px] px-8">
        ...
        <div className="flex flex-col w-[760px] h-[400px] justify-center gap-4">
            ...
            <p className="text-lg">
                I am a current undergraduate student in Computer Science at Stanford University. 
