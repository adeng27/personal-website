    ...
    return (
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-gray-800 md:bg-gray-900 border-gray-700">
                {/* <li>
                    <a href="/questions" className="block py-2 px-3 text-white rounded md:p-0 hover:text-yellow-300" aria-current="page">Questions</a>
                </li> */}
                <li>
                    <Link href="resume.pdf" target="_blank" className="flex gap-2 py-2 px-3 text-white rounded md:p-0 hover:text-yellow-300" aria-current="page">
